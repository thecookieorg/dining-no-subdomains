...
class HoursControllerTest < ActionController::TestCase
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post :create, hour: { closed: @hour.closed, day: @hour.day, end_time: @hour.end_time, start_time: @hour.start_time }
    end
  ...
  test "should update hour" do
    patch :update, id: @hour, hour: { closed: @hour.closed, day: @hour.day, end_time: @hour.end_time, start_time: @hour.start_time }
    assert_redirected_to hour_path(assigns(:hour))
  end
