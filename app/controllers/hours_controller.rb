class HoursController < ApplicationController
  ...
  # GET /hours/new
  def new
    @hours = current_merchant.hours.build
  end
  ...
  # POST /hours.json
  def create
    @hour = current_merchant.hours.build(hour_params)
  ...
  private
    ...
    def hour_params
      params.require(:hour).permit(:day, :start_time, :end_time, :closed, :merchant_id, :location_hours_id, :_destroy)
    end
end
